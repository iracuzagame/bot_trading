...
#driver = webdriver.Chrome(service=Service("C:/Users/abel/Documents/Clases/Intensivo/pyquotex/quotex/chromedriver"), options=chrome_options)

# Abrir la página del broker
#driver.get("https://qxbroker.com/es")
